...
`pkg` CLI. It proves install, retry, service isolation, a cached `hello` install
and execution, uninstall, and safe absence. It does not yet prove an approved
local build, upgrade, rollback, or repair.
