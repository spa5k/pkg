...
These commands are available in alpha.56.
...
The signed alpha.56 channel contains 64,412 package records for Apple silicon
...
The public installer selects alpha.56.
