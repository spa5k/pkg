...
places it under `v0.1.0-alpha.3/`, computes its SHA-256, and renders the small
...
contain `v0.1.0-alpha.3/pkg-install` and
`v0.1.0-alpha.3/pkg-0.1.0-alpha.3-preview.pkg`.
