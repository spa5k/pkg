...
places it under `v0.1.0-alpha.2/`, computes its SHA-256, and renders the small
...
contain `v0.1.0-alpha.2/pkg-install` and
`v0.1.0-alpha.2/pkg-0.1.0-alpha.2-preview.pkg`.
