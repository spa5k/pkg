> [!WARNING]
> This directory is a historical archive of the custom private-Nix design.
> It is not normative. Use the active plan in
> [`../../determinate-nix-stacked-prs.md`](../../determinate-nix-stacked-prs.md).
> Any active or canonical wording preserved below describes the old plan at
> the time it was written.

# `pkg` Plan Set — Historical Archive

> **Status:** Historical and non-normative. This `README.md` was the
